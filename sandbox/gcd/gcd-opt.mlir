module {
  ...
  func.func @__main__(%arg0: !sigi.stack) -> !sigi.stack attributes {sigi.main, sigi.stackType = () -> ()} {
    ...
    call @test(%1) {sigi.stackType = (i32, i32, i32) -> ()} : (!sigi.stack) -> ()
    %out_stack, %value = sigi.pop %1 : i32
    return %out_stack : !sigi.stack
  }

    func.func private @test(%arg0: !sigi.stack) -> () attributes {sigi.stackType = (i32, i32, i32) -> ()} {
    %c0_i32 = arith.constant 0 : i32
    %out_stack, %value = sigi.pop %arg0 : i32
    %0 = arith.cmpi eq, %value, %c0_i32 : i32
    %5 = arith.cmpi ne, %value, %c0_i32 : i32
