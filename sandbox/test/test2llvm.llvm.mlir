module {
  ...
  llvm.func private @closure_wrapper_1(%arg0: !llvm.ptr, %arg1: !llvm.ptr) -> !llvm.ptr {
    ...
    %1 = llvm.call @closure_worker_1(%arg1) : (!llvm.ptr) -> !llvm.ptr
  ...
  ^bb1:  // pred: ^bb0
    ...
    %11 = llvm.call @while(%10, %9, %arg2, %arg3) : (i1, i32, !llvm.ptr, !llvm.ptr) -> i32
    %12 = llvm.load %0 : !llvm.ptr -> !llvm.ptr
    llvm.call @sigi_push_i32(%12, %11) : (!llvm.ptr, i32) -> ()
    llvm.br ^bb3(%12 : !llvm.ptr)
  ^bb2:  // pred: ^bb0
    llvm.br ^bb3(%8 : !llvm.ptr)
  ^bb3(%13: !llvm.ptr):  // 2 preds: ^bb1, ^bb2
    llvm.br ^bb4
  ^bb4:  // pred: ^bb3
    %14 = llvm.call @sigi_pop_i32(%13) : (!llvm.ptr) -> i32
  ...
  llvm.func @print_stack_and_pop(%arg0: i1, %arg1: i32) -> i32 attributes {sigi.stackType = (i1, i32) -> i32, sym_visibility = "private"} {
    ...
    %12 = llvm.call @malloc(%2) : (i64) -> !llvm.ptr
    %13 = llvm.mlir.addressof @closure_wrapper_1 : !llvm.ptr
    %14 = llvm.insertvalue %13, %4[0] : !llvm.struct<(ptr, i32, ptr, struct<()>)> 
    %15 = llvm.insertvalue %7, %14[1] : !llvm.struct<(ptr, i32, ptr, struct<()>)> 
    %16 = llvm.insertvalue %6, %15[2] : !llvm.struct<(ptr, i32, ptr, struct<()>)> 
    %17 = llvm.bitcast %12 : !llvm.ptr to !llvm.ptr
    llvm.store %16, %17 : !llvm.struct<(ptr, i32, ptr, struct<()>)>, !llvm.ptr
    %18 = llvm.call @while(%arg0, %arg1, %11, %17) : (i1, i32, !llvm.ptr, !llvm.ptr) -> i32
    llvm.return %18 : i32
  }
  ...
  llvm.func @__main__() -> !llvm.struct<(i32, i32)> attributes {sigi.stackType = () -> (i32, i32)} {
    ...
    llvm.store %7, %6 : !llvm.ptr, !llvm.ptr
    %8 = llvm.call @print_stack_and_pop(%5, %2) : (i1, i32) -> i32
    %9 = llvm.load %6 : !llvm.ptr -> !llvm.ptr
    %10 = llvm.call @sigi_pop_i32(%9) : (!llvm.ptr) -> i32
    llvm.store %9, %6 : !llvm.ptr, !llvm.ptr
    %11 = llvm.mlir.undef : !llvm.struct<(i32, i32)>
    %12 = llvm.insertvalue %10, %11[0] : !llvm.struct<(i32, i32)> 
    %13 = llvm.insertvalue %8, %12[1] : !llvm.struct<(i32, i32)> 
    llvm.return %13 : !llvm.struct<(i32, i32)>
  }
  llvm.func @main() -> i1 {
